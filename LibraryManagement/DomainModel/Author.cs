...
namespace LibraryManagement.DomainModel
{
    public class Author
    {
        ...
        [NotNullValidator(MessageTemplate = "The FirstName cannot be null", Ruleset = "AuthorNotNull")]
        ...
        [NotNullValidator(MessageTemplate = "The SecondName cannot be null", Ruleset = "AuthorNotNull")]
        ...
        [NotNullValidator(MessageTemplate = "The Gender cannot be null", Ruleset = "AuthorNotNull")]
